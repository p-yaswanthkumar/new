...
const Service = () => {
  ...
  return (
    <section className="w-full p-0 m-0">
      ...
      <div className="w-full bg-[#FDF9F4] py-16" data-aos="fade-up" data-aos-duration="1200">
  <div className="container mx-auto px-4 max-w-5xl">
    ...
    >
      ...
      <div className="container mx-auto px-4  mt-20 py-10 max-w-4xl" data-aos="fade-up" data-aos-duration="1200">
      ...
      <div className="w-full bg-[#FDF9F4] mt-20 py-10" data-aos="fade-up" data-aos-duration="1200">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-start">
            ...
            <div className="mt-20 mb-20 grid grid-cols-1 gap-4" data-aos="slide-left" data-aos-delay="400">
              {challenges.map((c, i) => (
                <motion.div 
                  key={i} 
                  className="bg-white rounded-xl shadow-md p-5 border-l-4 border-orange-400 flex items-start"
                  initial={{ opacity: 0, x: 20 }}
                  animate={{ opacity: 1, x: 0 }}
      ...
      <div className="container mx-auto px-4 py-10 w-full" data-aos="fade-up" data-aos-duration="1200">
        ...
        <div className="grid lg:grid-2 gap-8">
          {workflowSteps.map((step, i) => (
            <motion.div 
              key={i} 
              className="bg-white rounded-xl shadow-md p-6 flex flex-col items-start border-t-4 border-orange-400 relative"
              data-aos="fade-up" 
