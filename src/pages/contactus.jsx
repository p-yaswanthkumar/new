...
export default function ContactHero() {
  ...
  return (
    <div className={theme === 'dark' ? 'min-h-screen text-white' : 'min-h-screen  text-black'}>
      {/* Hero Section */}
      <section className={`relative h-screen flex items-center justify-center ${theme === 'dark' ? '' : ''} overflow-hidden`} data-aos="fade-up" data-aos-delay="100"> 
        {/* Background video */}
        <video
          autoPlay
          muted
        ...
        <div className={theme === 'dark' ? 'absolute inset-0 bg-black/60 text-white -z-10' : 'absolute inset-0 bg-black/40 text-white -z-10'} data-aos="fade" data-aos-delay="140"></div>

        {/* Content */}
        <div className="flex flex-col items-center justify-center  text-white text-center" data-aos="fade-up" data-aos-delay="160">
  <h1 className="text-3xl md:text-6xl font-extrabold mb-4 leading-tight whitespace-nowrap" data-aos="fade-up" data-aos-delay="180">
    Plan, <span className="text-yellow-400" data-aos="zoom-in" data-aos-delay="200">Design & Build</span> — Together
  </h1>
  <p className="text-lg md:text-2xl font-light mb-6" data-aos="fade-up" data-aos-delay="220">
    Designing <span className="text-yellow-400 font-semibold" data-aos="zoom-in" data-aos-delay="240">spaces</span>, delivering 
    <span className="text-yellow-400 font-semibold" data-aos="zoom-in" data-aos-delay="260"> excellence</span> — your vision, our expertise.
  </p>
</div>
      </section>

      {/* Contact Cards Section */}
      <section className={`py-16 ${theme === 'dark' ? 'bg-[#222]' : 'bg-white'} overflow-hidden`} data-aos="fade-up" data-aos-delay="280"> 
      <div className="max-w-6xl mx-auto px-6" data-aos="fade-up" data-aos-delay="300">
        {/* Section Heading */}
        <h2 className={`text-3xl md:text-4xl font-bold text-center mb-12 ${theme === 'dark' ? 'text-yellow-400' : 'text-yellow-400'}`} data-aos="fade-up" data-aos-delay="320"> 
          Meet Our Support Team
        </h2>
        {/* Cards Grid */}
        <div className="grid gap-10 md:grid-cols-3" data-aos="fade-up" data-aos-delay="340">
          {cards.map((card, index) => (
            <div
              ...
              data-aos="zoom-in" data-aos-delay={360 + index * 20}
            >
              <img
                src={card.img}
                alt={card.title}
      ...
      <section className={`py-20 ${theme === 'dark' ? 'bg-[#181818]' : 'bg-gray-100'} overflow-hidden`} data-aos="fade-up" data-aos-delay="400"> 
      <div className="max-w-4xl mx-auto px-6" data-aos="fade-up" data-aos-delay="420">
        {/* Small Heading */}
        <p className="text-yellow-400 font-semibold uppercase mb-2" data-aos="fade-up" data-aos-delay="440">
          Get in Touch
        </p>
        {/* Main Heading */}
        <h2 className={`text-3xl md:text-4xl font-extrabold mb-10 ${theme === 'dark' ? 'text-white' : 'text-gray-900'}` } data-aos="fade-up" data-aos-delay="460">
          Need help? <span className="text-yellow-400">Let's get in touch</span>
        </h2>
      ...
      <section className={`py-20 ${theme === 'dark' ? 'bg-[#222]' : 'bg-white'} overflow-hidden`} data-aos="fade-up" data-aos-delay="500"> 
      <div className="max-w-6xl mx-auto px-6" data-aos="fade-up" data-aos-delay="520">
        {/* Small heading */}
        <p className="text-yellow-400 font-semibold uppercase mb-2" data-aos="fade-up" data-aos-delay="540">
          Location
        </p>

        {/* Main heading */}
        <h2 className={`text-3xl md:text-4xl font-extrabold mb-10 ${theme === 'dark' ? 'text-white' : 'text-gray-900'}`} data-aos="fade-up" data-aos-delay="560">
          How to <span className="text-yellow-400">Reach</span> Our Location
        </h2>

        {/* Map embed */}
        <div className="rounded-2xl overflow-hidden shadow-lg" data-aos="fade-up" data-aos-delay="580">
          <iframe
      ...
      <section className={`py-20 ${theme === 'dark' ? 'bg-[#181818]' : 'bg-gray-100'} overflow-hidden`} data-aos="fade-up" data-aos-delay="600"> 
      <div className="max-w-7xl mx-auto px-6 grid  md:grid-cols-2 gap-12 items-center" data-aos="fade-up" data-aos-delay="620">
        {/* Left: Image and Heading */}
        <div data-aos="fade-right" data-aos-delay="640">
          <p className="text-yellow-400 font-semibold uppercase mb-2" data-aos="fade-up" data-aos-delay="660">
            Frequently Asked Questions
          </p>
          <h2 className={`text-4xl md:text-5xl font-extrabold mb-8 ${theme === 'dark' ? 'text-white' : 'text-gray-900'}`} data-aos="fade-up" data-aos-delay="680">
        ...
        <div className="space-y-4" data-aos="fade-left" data-aos-delay="720">
          {faqs.map((faq, index) => (
            <div 
              ...
              data-aos="zoom-in" data-aos-delay={740 + index * 20}
            >
              <button 
    ...
    >
      <div
        ...
        data-aos="fade-up" data-aos-delay="820"
      >
        {/* Left side: Text and Form */}
        <div className="flex flex-col items-center lg:items-start text-center lg:text-left" data-aos="fade-right" data-aos-delay="840">
          {/* Main Title with highlighted word */}
          <h2
            className={`text-3xl md:text-4xl font-bold mb-2 ${
              theme === "dark" ? "text-white" : "text-gray-800"
            }`}
            data-aos="fade-up" data-aos-delay="860"
          >
            SUBSCRIBE <span className="text-yellow-400" data-aos="zoom-in" data-aos-delay="880">NEWSLETTER</span>
          </h2>
          ...
          <form className="w-full max-w-md flex flex-col sm:flex-row gap-4" data-aos="fade-up" data-aos-delay="920">
            <input
              type="email"
        ...
        <div className="flex justify-center lg:justify-end" data-aos="fade-left" data-aos-delay="940">
          <img
            src={jcbImage}
