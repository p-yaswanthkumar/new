...
import aihero from "../assets/ren.mp4";
import a1 from "../assets/ren1.png"; // your AI/ML service image
import a2 from "../assets/ren2.jpg"; // another AI/ML service 

const benefits = [
  {
    title: "Customized Renovation Plans",
    description: "Solutions tailored to upgrade your existing spaces without compromising on comfort or functionality.",
  },
  {
    title: "Structural and Aesthetic Improvements",
    description: "From foundation fixes to modern finishes, we enhance both strength and style.",
  },
  {
    title: "Smart Space Reconfiguration",
    description: "Redesign layouts to make better use of available space while improving flow.",
  },
  {
    title: "On-Time Project Delivery",
    description: "Systematic planning ensures your remodeling project is completed as scheduled.",
  },
  {
    title: "Clear and Honest Pricing",
    description: "Upfront cost estimates with no hidden surprises during or after the renovation.",
  },
  {
    title: "Skilled Renovation Experts",
    description: "Experienced teams handle everything from demolition to detailing with precision.",
  },
];
const steps = [
  "Initial consultation to assess current structure and identify goals",
  "Design concepts with before-and-after visualizations",
  "Transparent cost estimation and approval",
  "Careful demolition and preparation of existing spaces",
  "Upgrading materials, fixtures, and finishes with strict quality checks",
  "Final inspection, snag fixes, and handover with support",
];
...
export default function AIServicePage() {
  ...
  // AOS initialization (must be inside the component)
  React.useEffect(() => {
    AOS.init({ once: false });
  }, []);
  ...
  >
    ...
    <span style={{ color: '#facc15' /* Tailwind yellow-400 */ }} data-aos="zoom-in" data-aos-delay="200">Renovation & Remodeling</span>
  </h1>
...
>
  We breathe new life into your spaces — upgrading layouts, finishes, and functionality 
  to match your evolving lifestyle, all while ensuring quality craftsmanship and on-time delivery.
</p>
...
>
  We guide you through every stage  final reveal 
  ensuring your renovation or remodel is smooth, transparent, and perfectly aligned with your vision.
</p>
...
<section className={`w-full py-20 ${theme === "dark" ? "bg-[#222]" : "bg-white"}`} data-aos="fade-up" data-aos-delay="600"> 
  <div className="max-w-7xl mx-auto px-6" data-aos="fade-up" data-aos-delay="620">
    <h2 className={`text-3xl md:text-4xl font-bold mb-6 ${theme === "dark" ? "text-yellow-400" : "text-yellow-400"}`} data-aos="fade-up" data-aos-delay="640"> 
      Cost Estimator – Provide Your Details
    </h2>
...
>
  This project showcases our ability to merge comfort, style, and 
  functionality. From concept to execution, we created a home that’s 
  warm, inviting, and uniquely tailored to the client’s lifestyle.
</p>
...
>
  <li className="grid grid-cols-[auto_1fr] gap-2">
    ...
    4,200 sq.ft villa transformed into a contemporary living space.
  </li>
  <li className="grid grid-cols-[auto_1fr] gap-2">
    <span className="text-yellow-400">•</span>
    Bespoke interiors with smart storage and luxury finishes.
  </li>
  <li className="grid grid-cols-[auto_1fr] gap-2">
    <span className="text-yellow-400">•</span>
    Delivered within budget with seamless project coordination.
  </li>
</ul>
